...
#' @param T0: Initial temperature value in Kelvin.
#' @param F0: Initial forcing value in W/m^2.
#' @param Cap: Heat capacity in W yr m^(−2) K^(−1).
...
#' solve_ebm(0.1, 1, 0, 0, 10.1, forc_vals)
solve_ebm <- function(lambda, weights, T0, F0, Cap, forc_vals) {
